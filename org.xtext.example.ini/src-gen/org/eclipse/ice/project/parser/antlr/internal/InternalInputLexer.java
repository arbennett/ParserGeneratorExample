...
public class InternalInputLexer extends Lexer {
    ...
    public final void mRULE_WHITESPACE() throws RecognitionException {
        try {
            ...
            // InternalInput.g:257:17: ( ( ' ' | '\\t' )+ )
            // InternalInput.g:257:19: ( ' ' | '\\t' )+
            {
            // InternalInput.g:257:19: ( ' ' | '\\t' )+
            int cnt1=0;
            loop1:
    ...
    public final void mRULE_NEWLINE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInput.g:259:14: ( ( '\\r' )? ( '\\n' )+ )
            // InternalInput.g:259:16: ( '\\r' )? ( '\\n' )+
            {
            // InternalInput.g:259:16: ( '\\r' )?
            int alt2=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInput.g:261:9: ( ( 'A' .. 'Z' | 'a' .. 'z' ) ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '-' | '\\\\' | '/' | '0' .. '9' )* )
            // InternalInput.g:261:11: ( 'A' .. 'Z' | 'a' .. 'z' ) ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '-' | '\\\\' | '/' | '0' .. '9' )*
            {
            ...
            // InternalInput.g:261:31: ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '-' | '\\\\' | '/' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInput.g:263:14: ( '#' (~ ( ( '\\n' | '\\r' ) ) )* )
            // InternalInput.g:263:16: '#' (~ ( ( '\\n' | '\\r' ) ) )*
            {
            match('#'); 
            // InternalInput.g:263:20: (~ ( ( '\\n' | '\\r' ) ) )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_OPEN() throws RecognitionException {
        try {
            int _type = RULE_OPEN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInput.g:265:11: ( '[' )
            // InternalInput.g:265:13: '['
            {
            match('['); 
    ...
    public final void mRULE_CLOSE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInput.g:267:12: ( ']' )
            // InternalInput.g:267:14: ']'
            {
            match(']'); 
    ...
    public final void mRULE_ASSIGN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInput.g:269:13: ( '=' )
            // InternalInput.g:269:15: '='
            {
            match('='); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInput.g:271:10: ( ( '0' .. '9' )+ )
            // InternalInput.g:271:12: ( '0' .. '9' )+
            {
            // InternalInput.g:271:12: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInput.g:273:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalInput.g:273:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalInput.g:273:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalInput.g:273:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalInput.g:273:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                    ...
                    break;
                case 2 :
                    // InternalInput.g:273:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalInput.g:273:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInput.g:275:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalInput.g:275:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalInput.g:275:24: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInput.g:277:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalInput.g:277:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalInput.g:277:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInput.g:279:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalInput.g:279:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalInput.g:279:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt14=0;
            loop14:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInput.g:281:16: ( . )
            // InternalInput.g:281:18: .
            {
            matchAny(); 
